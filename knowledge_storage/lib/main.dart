...
import 'package:knowledge_storage/database/storage_db_helper.dart';
import 'package:knowledge_storage/screen/home_screen.dart';
...
Future<void> main() async {
  ...
  List<Miscellaneou> test = jsonString.map((e) => Miscellaneou.fromJson(e)).toList();

  print(test);

  final storagedb = StorageDbHelper();

  print(await storagedb.getMiscellaneousById());
}
